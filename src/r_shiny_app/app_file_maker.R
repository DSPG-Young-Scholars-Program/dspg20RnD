...
#All topics
topics <- read_csv("~/git/dspg20rnd/dspg20RnD/src/r_shiny_app_v2/data/CORONATHIRTY.csv")
topics <- topics %>%
...
#Coronavirus topics
corona <- read_csv("~/git/dspg20rnd/dspg20RnD/src/r_shiny_app_v2/data/CORONATHIRTY.csv")
corona <- corona %>%
  filter(START_YEAR > 2009)
